...
func main() {
	...
	if err != nil {
		crash("Error creating Discord session: ", err)
	}
...
func messageCreate(s *discordgo.Session, m *discordgo.MessageCreate) {
	...
	if strings.HasPrefix(m.Content, "!rr") {
...
func playSound(s *discordgo.Session, guildID, channelID, videoURL string) (err error) {
